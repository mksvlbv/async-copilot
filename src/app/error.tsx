...
export default function GlobalError({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10 sm:px-6">
      <div className="max-w-md w-full bg-white border border-gray-200 rounded-xl shadow-sm p-5 text-center sm:p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">
          A run or API call hit an unexpected error. You can retry below or head back to the workspace.
        </p>
        {error?.digest && (
